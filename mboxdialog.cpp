...
void MBoxDialog::on_QuestionBt_clicked()
{
...
void MBoxDialog::on_WarningBt_clicked()
{
...
void MBoxDialog::on_InformationBt_clicked()
{
    QMessageBox::information(this,"Information",tr("这是信息显示内容"));
}

void MBoxDialog::on_CriticalBt_clicked()
{
...
void MBoxDialog::on_AboutBt_clicked()
{
...
void MBoxDialog::on_AboutQTBt_clicked()
{
...
void MBoxDialog::on_CustomBt_clicked()
{
    ...
    customMsgBox.setIconPixmap(QPixmap(":/new/prefix1/custom.png"));
